            ...
            if ($request->filled('opaqueDataValue') && $request->filled('opaqueDataDescriptor')) {
                ...
                if ($response->isSuccessful()) {
                    ...
                    if ($paymentFor == "membership") {
                        ...
                        $file_name = $this->makeInvoice($requestData, "membership", $vendor, $password, $amount, "Authorized.Net", $requestData['phone'], $bs->base_currency_symbol_position, $bs->base_currency_symbol, $bs->base_currency_text, $transaction_id, $package->title, $lastMemb);
