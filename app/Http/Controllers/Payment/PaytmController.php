    ...
    public function paymentStatus(Request $request)
    {
        ...
        if ($request["STATUS"] === "TXN_FAILURE") {
            ...
            if ($paymentFor == "membership") {
                ...
                $file_name = $this->makeInvoice($requestData, "membership", $vendor, $password, $amount, "Paytm", $requestData['phone'], $bs->base_currency_symbol_position, $bs->base_currency_symbol, $bs->base_currency_text, $transaction_id, $package->title, $lastMemb);
