        ...
        if (!empty($request->paymentId)) {
            ...
            if ($result && $result['IsSuccess'] == true && $result['Data']['InvoiceStatus'] == "Paid") {
                ...
                if ($paymentFor == "membership") {
                    ...
                    $file_name = $this->makeInvoice($requestData, "membership", $vendor, $password, $amount, "Myfatoorah", $requestData['phone'], $bs->base_currency_symbol_position, $bs->base_currency_symbol, $bs->base_currency_text, $transaction_id, $package->title, $lastMemb);
