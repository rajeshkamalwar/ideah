        ...
        if ($request['status_id'] == 1 && $request['order_id'] == $ref) {
            ...
            if ($request['payment_request_id'] == $payment_id) {
                ...
                if ($paymentFor == "membership") {
                    ...
                    $file_name = $this->makeInvoice($requestData, "membership", $vendor, $password, $amount, "Toyyibpay", $requestData['phone'], $bs->base_currency_symbol_position, $bs->base_currency_symbol, $bs->base_currency_text, $transaction_id, $package->title, $lastMemb);
