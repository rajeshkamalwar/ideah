    ...
    public function successPayment(Request $request)
    {
        ...
        if ($request['trxref'] === $request['reference']) {
            ...
            if ($paymentFor == "membership") {
                ...
                $file_name = $this->makeInvoice($requestData, "membership", $vendor, $password, $amount, "Paystack", $requestData['phone'], $bs->base_currency_symbol_position, $bs->base_currency_symbol, $bs->base_currency_text, $transaction_id, $package->title, $lastMemb);
