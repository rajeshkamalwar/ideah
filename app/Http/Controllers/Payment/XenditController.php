...
class XenditController extends Controller
{
    public function index(Request $request, $_amount, $_title, $_cancel_url)
    {
        ...
        if (!empty($response['success_redirect_url'])) {
            ...
            // claim,t context keep before redirecting to xendit
    ...
    public function callback($request)
    {
        ...
        if ($data['status'] == 'PAID') {
            ...
            if ($paymentFor == "membership") {
                ...
                $file_name = $this->makeInvoice($requestData, "membership", $vendor, $password, $amount, "Xendit", $requestData['phone'], $bs->base_currency_symbol_position, $bs->base_currency_symbol, $bs->base_currency_text, $transaction_id, $package->title, $lastMemb);
