...
class SupportTicketController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.user.support_ticket.index', $information);
    }
    ...
    public function create()
    {
        ...
        $information['pageHeading'] = $misc->getPageHeading($language);
        $information['bgImg'] = $misc->getBreadcrumb();
        return view('frontend.user.support_ticket.create', $information);
    }
    ...
    public function store(Request $request)
    {
        ...
        Session::flash('success', __('Ticket has been submitted successfully') . '!');
        return back();
    }
    ...
    public function message($id)
    {
        ...
        $information['ticket'] = SupportTicket::where('id', $id)->firstOrFail();

        return view('frontend.user.support_ticket.message', $information);
    }
    //reply
