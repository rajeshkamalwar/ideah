...
class WithdrawPaymentMethodInputController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $messages = [
            'options.*.required_if' => __('Options are required if field type is select dropdown/checkbox') . '.',
        ...
        Session::flash('success', __('New Input Feild Added successfully') . '!');
    ...
    public function update(Request $request)
    {
        ...
        Session::flash('success', __('Input Updated successfully') . '!');
    ...
    public function delete(Request $request)
    {
        ...
        $input->delete();
        Session::flash('success', __('Input Feild Deleted Successfully') . '!');
