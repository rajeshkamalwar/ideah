    ...
    public function update(Request $request)
    {
        ...
        if ($request->status === "1") {
            ...
            if ($count_membership > 1) {
                ...
                $mailTemplate = 'payment_accepted_for_membership_offline_gateway';
            ...
            $membership->update(['invoice' => $filename]);
            ...
            // Fulfill claim & reassign listing if this membership was created from a claim
            if (!empty($membership->claim_id)) {
                app(ClaimAttachService::class)
                    ->attachByClaimId((int)$membership->vendor_id, (int)$membership->claim_id);
            }
            ...
            if ($count_membership > 1) {
                ...
                $mailTemplate = 'payment_rejected_for_membership_offline_gateway';
