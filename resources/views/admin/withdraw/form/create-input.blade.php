<div class="card">
  <div class="card-header">
    <div class="card-title">{{ __('Create Input Field') }}</div>
  </div>
  ...
  <form id="ajaxForm" action="{{ route('admin.withdraw_payment_method.store_input') }}" method="post"
    ...
    <div class="form-group">
      <label for=""><strong>{{ __('Input Field Type') }}</strong></label>
      <div class="">
    ...
    <div class="form-group">
      <label for=""><strong>{{ __('Label') }}</strong></label>
      <div class="">
        <input type="text" class="form-control" name="label" value="" placeholder="{{ __('Enter Input Label') }}">
      </div>
    ...
    <div class="form-group text-center">
      <button id="submitBtn" type="submit" class="btn btn-primary btn-sm">{{ __('Submit') }}</button>
    </div>
  </form>
