    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">{{ __('Add Payment Method') }}</h5>
            ...
            <div class="modal-body">
                <form id="ajaxForm" class="modal-form create"
                    action="{{ route('admin.withdraw_payment_method.store') }}" method="post"
                    ...
                    <div class="form-group">
                        <label for="">{{ __('Fixed Charge') . ' ' }}({{ __('in') }}
                            {{ $websiteInfo->base_currency_text }})</label>
                        <input type="number" class="form-control" value="0.00" name="fixed_charge"
                    ...
                    <div class="form-group">
                        <label for="">{{ __('Percentage Charge') }} ({{ __('in') }}
                            {{ $websiteInfo->base_currency_text }})</label>
                        <input type="number" class="form-control" value="0.00" name="percentage_charge"
