      ...
      <div class="card">
        <div class="card-header">
          ...
          <a class="btn btn-info btn-sm float-right d-inline-block"
            href="{{ route('admin.announcement_popups', ['language' => $defaultLang->code]) }}">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
              <form id="ajaxEditForm" action="{{ route('admin.announcement_popups.update_popup', ['id' => $popup->id]) }}"
                ...
                <div class="form-group">
                  ...
                  <div class="thumb-preview">
                    <img src="{{ asset('assets/img/popups/' . $popup->image) }}" alt="popup image" class="uploaded-img">
                  </div>
                  ...
                  <div class="row">
                    <div class="col">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="title" placeholder="{{ __('Enter Popup Title') }}"
                          value="{{ $popup->title }}">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="button_text" placeholder="{{ __('Enter Button Text') }}"
                    ...
                    <div class="col">
                      <div class="form-group">
                        ...
                        <input type="url" class="form-control ltr" name="button_url"
                          placeholder="Enter Button URL" value="{{ $popup->button_url }}">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control datepicker ltr" name="end_date"
                          placeholder="{{ __('Enter End Date') }}" readonly autocomplete="off" value="{{ $endDate }}">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control timepicker ltr" name="end_time"
                          placeholder="{{ __('Enter End Time') }}" readonly autocomplete="off" value="{{ $endTime }}">
                ...
                <div class="row">
                  <div class="col">
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control ltr" name="delay" placeholder="{{ __('Enter Popup Delay') }}"
                        value="{{ $popup->delay }}">
                  ...
                  <div class="col">
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control ltr" name="serial_number"
                        placeholder="Enter Serial Number" value="{{ $popup->serial_number }}">
