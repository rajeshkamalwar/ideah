...
@section('content')
              ...
              <div class="row">
                <div class="col-lg-12">
                  <form id="testimonialFormBg"
                    action="{{ route('admin.about_us.update_testimonial_section_background', ['language' => request()->input('language')]) }}"
              ...
              <div class="row">
                <div class="col-lg-12">
                  <form id="testimonialForm"
                    action="{{ route('admin.about_us.update_testimonial_section', ['language' => request()->input('language')]) }}"
                    method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                      <div class="col">
          ...
          <div class="row">
            ...
            <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
              ...
              <button class="btn btn-danger btn-sm float-right mr-2 d-none bulk-delete"
                data-href="{{ route('admin.about_us.bulk_delete_testimonial') }}">
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <form class="deleteForm d-inline-block"
                              action="{{ route('admin.about_us.delete_testimonial', ['id' => $testimonial->id]) }}"
                              method="post">
                              @csrf
  ...
  {{-- create modal --}}
  @include('admin.about-us.testimonial-section.create')

  {{-- edit modal --}}
  @include('admin.about-us.testimonial-section.edit')
@endsection
