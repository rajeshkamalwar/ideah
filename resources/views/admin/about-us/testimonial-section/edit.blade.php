  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="ajaxEditForm" class="modal-form" action="{{ route('admin.about_us.update_testimonial') }}"
          ...
          @if ($themeInfo->theme_version == 3)
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="rating" placeholder="{{ __('Enter Rating') }}"
                id="in_rating">
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" name="comment" placeholder="{{ __('Enter Client Comment') }}" rows="4" id="in_comment"></textarea>
