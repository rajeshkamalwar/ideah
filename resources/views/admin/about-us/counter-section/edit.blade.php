  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="ajaxEditForm" class="modal-form" action="{{ route('admin.about_us.update_counter') }}"
          method="post">
          @csrf
          ...
          <div class="form-group">
            ...
            <input type="number" class="form-control ltr" name="amount" placeholder="{{ __('Enter Amount') }}" id="in_amount">
