...
@section('content')
        ...
        <div class="col-md-12">
          <div class="card">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-lg-12">
                  <form id="counterImgForm" action="{{ route('admin.about_us.update_counter_section_image') }}"
        ...
        <div class="col-md-12">
          <div class="card">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-lg-12">
                  <form id="counterInfoForm" action="{{ route('admin.about_us.update_counter_section_info') }}"
                    method="POST" enctype="multipart/form-data">
                    @csrf
          ...
          <div class="row">
            ...
            <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
              ...
              <button class="btn btn-danger btn-sm float-right mr-2 d-none bulk-delete"
                data-href="{{ route('admin.about_us.bulk_delete_counter') }}">
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <form class="deleteForm d-inline-block"
                              action="{{ route('admin.about_us.delete_counter', ['id' => $counter->id]) }}"
                              method="post">
                              @csrf
  ...
  {{-- create modal --}}
  @include('admin.about-us.counter-section.create')

  {{-- edit modal --}}
  @include('admin.about-us.counter-section.edit')
@endsection
