...
@section('content')
    ...
    <div class="col-md-6">
      <div class="card">
        <div class="card-header">
          <div class="row">
            <div class="col-lg-8">
              <div class="card-title">{{ __('Work Process Section') }}</div>
            </div>
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-12">
              <form id="workForm"
                action="{{ route('admin.about_us.update_work_process_section', ['language' => request()->input('language')]) }}"
                method="POST">
                @csrf
                <div class="row">
                  <div class="col-lg-12">
          ...
          <div class="row">
            ...
            <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
              ...
              <button class="btn btn-danger btn-sm float-right mr-2 d-none bulk-delete"
                data-href="{{ route('admin.about_us.bulk_delete_work_process') }}">
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <form class="deleteForm d-inline-block"
                              action="{{ route('admin.about_us.delete_work_process', ['id' => $process->id]) }}"
                              method="post">
                              @csrf
  ...
  {{-- create modal --}}
  @include('admin.about-us.work-process-section.create')

  {{-- edit modal --}}
  @include('admin.about-us.work-process-section.edit')
@endsection
