  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="ajaxEditForm" class="modal-form" action="{{ route('admin.footer.update_quick_link') }}"
          method="post">
          @csrf
          ...
          <div class="form-group">
            ...
            <input type="text" id="in_title" class="form-control"
              name="title"placeholder="{{ __('Enter Quick Link Title') }}">
            <p id="editErr_title" class="mt-2 mb-0 text-danger em"></p>
          </div>

          <div class="form-group">
            <label for="">{{ __('URL') . '*' }}</label>
            <input type="url" id="in_url" class="form-control ltr"
              name="url"placeholder="{{ __('Enter Quick Link URL') }}">
