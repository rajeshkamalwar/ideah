                ...
                <div class="form-group">
                  ...
                  <div class="thumb-preview">
                    @if (!empty($info->hero_section_background_img))
                      <img src="{{ asset('assets/img/hero-section/' . $info->hero_section_background_img) }}"
            ...
            <form id="actionForm"
              ...
              <div class="col-lg-12">
                <div class="form-group">
                  ...
                  <textarea name="text" class="form-control" rows="12" placeholder="{{ __('Enter Text') }}">{{ empty($data->text) ? '' : $data->text }}</textarea>
                </div>
              </div>
            </form>
          </div>
