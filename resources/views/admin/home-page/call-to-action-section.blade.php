                ...
                <div class="row">
                  ...
                  @if ($settings->theme_version == 1)
                    <div class="form-group col-lg-6">
                      ...
                      <br>
                      <div class="thumb-preview">
                        @if (!empty($info->call_to_action_section_highlight_image))
                          <img src="{{ asset('assets/img/' . $info->call_to_action_section_highlight_image) }}"
                      ...
                      <div class="mt-3">
                        <div role="button" class="btn btn-primary btn-sm upload-btn">
                          {{ __('Choose Image') }}
                          <input type="file" class="img-input3" name="call_to_action_section_highlight_image">
                        </div>
                      </div>
