...
@section('content')
  <div class="page-header">
    <h4 class="page-title">{{ __('Pending Requests') }}</h4>
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <div class="row">
            <div class="col-lg-10">
              <form id="searchForm" action="{{ route('admin.featured_listing.pending_request') }}" method="GET">
                <div class="row">
                  <div class="col-lg-4">
