    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <div class="row">
            <div class="col-lg-10">
              <form id="searchForm" action="{{ route('admin.featured_listing.all_request') }}" method="GET">
                <div class="row">
                  <div class="col-lg-3">
                          ...
                          <td class="title">
                            ...
                            @if (!empty($listing_content))
                              <a href="{{ route('frontend.listing.details', ['slug' => $listing_content->slug, 'id' => $listing_content->listing_id]) }}"
                                target="_blank">
                                {{ strlen(@$listing_content->title) > 60 ? mb_substr(@$listing_content->title, 0, 60, 'utf-8') . '...' : @$listing_content->title }}
                              </a>
                            @else
                              --
                            @endif
                          ...
                          <td>
                            ...
                            @else
                              <h2 class="d-inline-block"><span
                                  ...
                                  {{ $order->order_status == 'completed' ? __('approved') : __($order->order_status) }}
                                </span>
                              </h2>
                            @endif
                          </td>
                          ...
                          <td>
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                ...
                                @if ($order->invoice)
                                  <a href="{{ asset('assets/file/invoices/listing-feature/' . $order->invoice) }}"
