  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="ajaxEditForm" class="modal-form" action="{{ route('admin.featured_listing.update') }}" method="post">
          @csrf
          <input type="hidden" name="id" id="in_id">

          <div class="form-group">
            <label for="">{{ __('Days') . '*' }}</label>
            <input type="text" class="form-control" name="days" placeholder="{{ __('Enter Days') }}"
              id="in_days">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="price" placeholder="{{ __('Enter Price') }}"
              id="in_price">
