      ...
      <div class="card">
        <form
          ...
          <div class="card-header">
            <div class="row">
              <div class="col-lg-10">
                <div class="card-title">{{ __('Page Headings') }}</div>
              </div>
              <div class="col-lg-2">
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-10 offset-lg-1">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>{{ __('Events Page Title') . '*' }}</label>
                      <input type="text" class="form-control" name="events_page_title"
                        value="{{ $data != null ? $data->events_page_title : '' }}">
                      @error('events_page_title')
                        <p class="mt-2 mb-0 text-danger">{{ $message }}</p>
                      @enderror
                    </div>
                  </div>
