          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-lg-6">
                ...
                <div class="form-group">
                  <label>{{ __('Meta Description For Listings Page') }}</label>
                  <textarea class="form-control" name="meta_description_listings" rows="5"
                    placeholder="{{ __('Enter Meta Description') }}">{{ is_null($data) ? '' : $data->meta_description_listings }}</textarea>
                </div>
              </div>
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input class="form-control" name="meta_keyword_events"
                    value="{{ is_null($data) ? '' : $data->meta_keyword_events }}"
                    placeholder="{{ __('Enter Meta Keywords') }}" data-role="tagsinput">
                </div>

                <div class="form-group">
                  <label>{{ __('Meta Description For Events Page') }}</label>
                  <textarea class="form-control" name="meta_description_events" rows="5"
                    placeholder="{{ __('Enter Meta Description') }}">{{ is_null($data) ? '' : $data->meta_description_events }}</textarea>
                </div>
              </div>
