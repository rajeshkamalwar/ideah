                  ...
                  <div class="col-lg-12">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="mail_subject"
                        placeholder="{{ __('Enter Mail Subject') }}" value="{{ $templateInfo->mail_subject }}">
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="form-group">
                      ...
                      <textarea class="form-control summernote" name="mail_body" placeholder="{{ __('Enter Mail Body Format') }}" data-height="300">{{ replaceBaseUrl($templateInfo->mail_body, 'summernote') }}</textarea>
