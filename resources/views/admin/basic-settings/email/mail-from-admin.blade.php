            ...
            <div class="row">
              <div class="col-lg-6 offset-lg-3">
                <div class="alert alert-warning text-center" role="alert">
                  <strong
                    class="text-dark">{{ __('This mail address will be used to send all mails from this website.') }}</strong>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="selectgroup w-100">
                    <label class="selectgroup-item">
                      <input type="radio" name="smtp_status" value="1" class="selectgroup-input"
                        {{ $data->smtp_status == 1 ? 'checked' : '' }}>
                      <span class="selectgroup-button">{{ __('Active') }}</span>
                    </label>
                    <label class="selectgroup-item">
                      <input type="radio" name="smtp_status" value="0" class="selectgroup-input"
                        {{ $data->smtp_status == 0 ? 'checked' : '' }}>
                      <span class="selectgroup-button">{{ __('Deactive') }}</span>
                    </label>
                  </div>
                  @if ($errors->has('smtp_status'))
                    <p class="mt-2 mb-0 text-danger">{{ $errors->first('smtp_status') }}</p>
                  @endif
                </div>
                ...
                <div class="form-group">
                  ...
                  @if ($errors->has('encryption'))
                    <p class="mt-2 mb-0 text-danger">{{ $errors->first('encryption') }}</p>
                  @endif
                </div>
                ...
                <div class="form-group">
                  ...
                  @if ($errors->has('from_mail'))
                    <p class="mt-2 mb-0 text-danger">{{ $errors->first('from_mail') }}</p>
                  @endif
                </div>
                ...
                <div class="form-group">
                  ...
                  @if ($errors->has('from_name'))
                    <p class="mt-2 mb-0 text-danger">{{ $errors->first('from_name') }}</p>
                  @endif
                </div>
              </div>
            </div>
