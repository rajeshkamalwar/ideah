            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a class="btn btn-info btn-sm float-right d-inline-block"
                        href="{{ route('admin.shop_management.select_product_type') }}">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select name="vendor_id" id="vendor_id" class="form-control">
                                                <option selected disabled>{{ __('Select a Vendor') }}</option>
...
@section('script')
    <script>
        ...
        const listingUrl = "{{ route('admin.shop_management.listings.byVendor') }}";
        let listingNotFound = "{{ __('No listing found for this vendor') }}";
    </script>
