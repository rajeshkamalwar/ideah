          ...
          <div class="row">
            ...
            <div class="col-sm-6 col-lg-4 offset-lg-1 mt-2 mt-lg-0">
              <div class="text-right">
                <a href="{{ route('admin.shop_management.select_product_type') }}" class="btn btn-primary btn-sm"><i
                        ...
                        <tr>
                          ...
                          @php
                            if($product && $product->listing_id && $product->placement_type == 2){
                              $listing_title = \App\Models\Listing\ListingContent::where('listing_id', $product->listing_id)
                              ->where('language_id', $defaultLang->id)->value('title');
                            }else{
                              $listing_title = '---';
                            }
                          @endphp
