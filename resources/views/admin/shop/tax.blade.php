...
@section('content')
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        <form action="{{ route('admin.shop_management.update_tax_amount') }}" method="post">
          @csrf
          <div class="card-header">
            <div class="row">
              <div class="col-lg-10">
                <div class="card-title">{{ __('Tax & Commission') }}</div>
              </div>
            </div>
          </div>
              ...
              <div class="col-lg-6 offset-lg-3">
                ...
                <div class="form-group">
                  ...
                  <input type="number" step="0.01" class="form-control" name="commission_amount"
                    value="{{ $data->commission_amount != null ? $data->commission_amount : '' }}"
