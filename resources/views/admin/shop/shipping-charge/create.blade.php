  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="ajaxForm" class="modal-form create" action="{{ route('admin.shop_management.store_charge') }}"
          method="post">
          @csrf
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" name="short_text" rows="2" cols="80"
              placeholder="{{ __('Enter Short Text') }}"></textarea>
          ...
          <div class="form-group">
            ...
            <input type="number" step="0.01" class="form-control ltr" name="shipping_charge"
              placeholder="{{ __('Enter Shipping Charge') }}">
