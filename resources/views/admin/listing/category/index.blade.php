                                        ...
                                        <tbody>
                                            @foreach ($categories as $category)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-info btn-sm mr-1 mt-1"
                                                            href="{{ route('admin.listing_specification.category_faq_templates', ['category' => $category->id]) }}"
                                                            title="{{ __('Category FAQ templates') }}">
