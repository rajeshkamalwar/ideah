    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="ajaxForm" class="modal-form create"
          action="{{ route('admin.listing_specification.location.store_state') }}" method="post">
          @csrf
          ...
          <div class="form-group d-none"id="hide_country">
            ...
            <select name="country_id" class="form-control">
              <option selected value="">{{ __('Select a country') }}</option>
            </select>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="name" placeholder="{{ __('Enter State Name') }}">
