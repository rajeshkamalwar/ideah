...
<div class="page-header">
    ...
    <ul class="breadcrumbs">
        ...
        <li class="nav-item">
            <a href="#">{{ __($form->name) }}</a>
        </li>
        <li class="separator">
            <i class="flaticon-right-arrow"></i>
        </li>
        <li class="nav-item">
            <a href="#">{{ __('Form Inputs') }}</a>
        </li>
                ...
                <div class="row">
                    <div class="col">
                        <p class="text-warning">
                            {{ '*' . __('Do not create') }} <span class="text-info">{{ __('Name, Email & Phone Number')
                                }}</span>
                        ...
                        <div class="ui-state-form">
                            ...
                            <div id="sort-content">
                                ...
                                <form class="ui-state-default"
                                    action="{{ route('admin.listings-management.form.delete_input', ['id' => $inputField->id]) }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row no-gutters">
                                            ...
                                            <div class="col-lg-2">
                                                <a href="{{ route('admin.listings-management.form.edit_input', ['form_id' => $form->id, 'input_id' => $inputField->id, 'language' => request()->input('language')]) }}"
                                        ...
                                        <div class="row no-gutters">
                                            <div class="col-lg-9 mr-3">
                                                <select class="form-control" name="{{ $inputField->name }}">
                                                    <option selected disabled>{{ $inputField->placeholder }}
                                                    </option>
                                            ...
                                            <div class="col-lg-2">
                                                <a href="{{ route('admin.listings-management.form.edit_input', ['form_id' => $form->id, 'input_id' => $inputField->id, 'language' => $defaultLang->code]) }}"
                                                    class="btn btn-sm btn-secondary mt-1">
                                                    <i class="fas fa-edit text-white "></i>
                                                </a>
                                            ...
                                            <div class="col-lg-9 mr-3">
                                                ...
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" id="{{ 'option-' . $loop->iteration }}"
                                                        name="values[]" class="custom-control-input">
                                        ...
                                        <div class="row no-gutters">
                                            <div class="col-lg-9 mr-3">
                                                <input type="text" class="form-control timepicker"
                                                    name="{{ $inputField->name }}"
                                                    placeholder="{{ $inputField->placeholder }}" readonly
                                                    autocomplete="off">
                                            </div>
                                ...
                                <form class="ui-state-default"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row no-gutters">
                                            <div class="col-lg-9 mr-3">
                                                <input type="file" name="{{ $inputField->name }}" class=" form-control">
                                            </div>
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <a href="{{ route('admin.listings-management.form.index', ['language' => $defaultLang->code]) }}"
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col">
                        <form id="ajaxForm"
                            action="{{ route('admin.listings-management.form.store_input', ['id' => $form->id]) }}"
                            method="POST">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-check form-check-inline pl-0">
                                    ...
                                    <label class="form-check-label mt-2" for="input-type-1">{{ __('Text Field')
                                        }}</label>
                                </div>
                                ...
                                <div class="form-check form-check-inline pl-0">
                                    <input type="radio" class="form-check-input" name="type" value="2" id="input-type-2"
                                        v-model="inputType" v-on:change="changeInputType()">
                                    <label class="form-check-label mt-2" for="input-type-2">{{ __('Number Field')
                                        }}</label>
                                </div>
                                ...
                                <div class="form-check form-check-inline pl-0">
                                    <input type="radio" class="form-check-input" name="type" value="6" id="input-type-6"
                                        v-model="inputType" v-on:change="changeInputType()">
                                    <label class="form-check-label mt-2" for="input-type-6">{{ __('Datepicker')
                                        }}</label>
                                </div>
                                ...
                                <div class="form-check form-check-inline pl-0">
                                    <input type="radio" class="form-check-input" name="type" value="7" id="input-type-7"
                                        v-model="inputType" v-on:change="changeInputType()">
                                    <label class="form-check-label mt-2" for="input-type-7">{{ __('Timepicker')
                                        }}</label>
                                </div>
...
<script type="text/javascript">
    let optArr = {!! json_encode([]) !!};
        ...
        const sortURL = "{{ route('admin.listings-management.form.sort_input') }}";
</script>
