...
@section('content')
    <div class="page-header">
        ...
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a
                    href="{{ route('admin.listings-management.form.index', ['language' => $defaultLang->code]) }}">{{ __('Forms') }}</a>
            </li>
            <li class="separator">
                <i class="flaticon-right-arrow"></i>
            </li>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-lg-2">
                            <a href="{{ route('admin.listings-management.form.input', ['id' => request()->route('form_id'), 'language' => $defaultLang->code]) }}"
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-6">
                            <form id="ajaxEditForm"
                                action="{{ route('admin.listings-management.form.update_input', ['id' => $inputField->id]) }}"
                                method="POST">
                                @csrf
                                    ...
                                    <div class="selectgroup w-100">
                                        <label class="selectgroup-item">
                                            <input type="radio" name="is_required" value="1"
                                                class="selectgroup-input" @if ($inputField->is_required == 1) checked @endif>
                                            <span class="selectgroup-button">{{ __('Yes') }}</span>
                                        </label>

                                        <label class="selectgroup-item">
                                            <input type="radio" name="is_required" value="0"
                                                class="selectgroup-input" @if ($inputField->is_required == 0) checked @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="label"
                                        placeholder="{{ __('Enter Input Label') }}" value="{{ $inputField->label }}">
                                        ...
                                        <div class="col-lg-10">
                                            <div class="form-group">
                                                <input type="text" class="form-control" name="options[]"
                                                    placeholder="{{ __('Enter Option') }}" v-bind:value="option">
                                            </div>
                                        </div>

                                        <div class="col-lg-2">
                                            <button type="button" class="btn btn-danger btn-sm mt-3"
                                                v-on:click="rmvOpt(index)">
