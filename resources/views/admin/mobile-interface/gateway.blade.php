                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <div class="selectgroup w-100">
                                        <label class="selectgroup-item">
                                            <input type="radio" name="status" value="1"
                                                class="selectgroup-input"
                                                {{ $yoco->mobile_status == 1 ? 'checked' : '' }}>
                                            <span class="selectgroup-button">{{ __('Active') }}</span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input type="radio" name="status" value="0"
                                                class="selectgroup-input"
                                                {{ $yoco->mobile_status == 0 ? 'checked' : '' }}>
                                            <span class="selectgroup-button">{{ __('Deactive') }}</span>
                                        </label>
                                    </div>
                                    @if ($errors->has('status'))
                                ...
                                @php $yocoInfo = json_decode($yoco->mobile_information, true); @endphp
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <div class="selectgroup w-100">
                                        <label class="selectgroup-item">
                                            <input type="radio" name="status" value="1"
                                                class="selectgroup-input"
                                                {{ $iyzico->mobile_status == 1 ? 'checked' : '' }}>
                                            <span class="selectgroup-button">{{ __('Active') }}</span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input type="radio" name="status" value="0"
                                                class="selectgroup-input"
                                                {{ $iyzico->mobile_status == 0 ? 'checked' : '' }}>
                                            <span class="selectgroup-button">{{ __('Deactive') }}</span>
                                        </label>
                                    </div>
                                    @if ($errors->has('status'))
                                ...
                                @php $iyzicoInfo = json_decode($iyzico?->mobile_information, true); @endphp
                                ...
                                <p class="text-warning"><strong>{{ __('Cron Job Command') }} :</strong>
                                    {{ __('curl -sS') }}
                                    {{ url('/') }}/subcheck
                                </p>
                                <p class="text-danger">
                                    {{ __('If you don\'t set up a cron job, the Iyzico payment method will not work.') }}
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <div class="selectgroup w-100">
                                        <label class="selectgroup-item">
                                            <input type="radio" name="instamojo_status" value="1"
                                                class="selectgroup-input"
                                                {{ $instamojo->mobile_status == 1 ? 'checked' : '' }}>
                                            <span class="selectgroup-button">{{ __('Active') }}</span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input type="radio" name="instamojo_status" value="0"
                                                class="selectgroup-input"
                                                {{ $instamojo->mobile_status == 0 ? 'checked' : '' }}>
                                            <span class="selectgroup-button">{{ __('Deactive') }}</span>
                                        </label>
                                    </div>
                                ...
                                @php $instamojoInfo = json_decode($instamojo->mobile_information, true); @endphp

                                <div class="form-group">
                                    <label>{{ __('Instamojo Test Mode') }}</label>
                                    <div class="selectgroup w-100">
                                        <label class="selectgroup-item">
                                            <input type="radio" name="instamojo_sandbox_status" value="1"
                                                class="selectgroup-input"
                                                {{ @$instamojoInfo['sandbox_status'] == 1 ? 'checked' : '' }}>
                                            <span class="selectgroup-button">{{ __('Active') }}</span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input type="radio" name="instamojo_sandbox_status" value="0"
                                                class="selectgroup-input"
                                    ...
                                    @if ($errors->has('instamojo_sandbox_status'))
                                        <p class="mt-1 mb-0 text-danger">{{ $errors->first('instamojo_sandbox_status') }}
                                        </p>
                                    @endif
                                </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <div class="selectgroup w-100">
                                        <label class="selectgroup-item">
                                            <input type="radio" name="status" value="1"
                                                class="selectgroup-input"
                                                {{ $paytabs->mobile_status == 1 ? 'checked' : '' }}>
                                            <span class="selectgroup-button">{{ __('Active') }}</span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input type="radio" name="status" value="0"
                                                class="selectgroup-input"
                                                {{ $paytabs->mobile_status == 0 ? 'checked' : '' }}>
                                            <span class="selectgroup-button">{{ __('Deactive') }}</span>
                                        </label>
                                    </div>
                                    @if ($errors->has('status'))
                                ...
                                @php $paytabsInfo = json_decode($paytabs->mobile_information, true); @endphp
                                ...
                                <div class="form-group">
                                    ...
                                    @endif
                                    <p class="mt-1 mb-0 text-warning">{{ __("You will get 'API Endpoit' from here.") }}
                                        <a href="https://prnt.sc/McaCbxt75fyi"
                                            target="_blank">https://prnt.sc/McaCbxt75fyi</a>, <a
                                            href="https://prnt.sc/DgztAyHVR2o8"
                                            target="_blank">https://prnt.sc/DgztAyHVR2o8</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <div class="selectgroup w-100">
                                        <label class="selectgroup-item">
                                            <input type="radio" name="status" value="1"
                                                class="selectgroup-input"
                                                {{ $perfect_money->mobile_status == 1 ? 'checked' : '' }}>
                                            <span class="selectgroup-button">{{ __('Active') }}</span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input type="radio" name="status" value="0"
                                                class="selectgroup-input"
                                                {{ $perfect_money->mobile_status == 0 ? 'checked' : '' }}>
                                            <span class="selectgroup-button">{{ __('Deactive') }}</span>
                                        </label>
                                    </div>
                                    @if ($errors->has('status'))
                                ...
                                @php $perfect_moneyInfo = json_decode($perfect_money->mobile_information, true); @endphp
                                ...
                                <div class="form-group">
                                    ...
                                    <p class="text-warning mt-1">{{ __('You will get wallet id form here') }} <a
                                            href="https://prnt.sc/bM3LqLXBduaq"
                                            target="_blank">https://prnt.sc/bM3LqLXBduaq</a></p>
                                </div>
                                <div class="form-group">
                                    <label>{{ __('Perfect Money Password') }}</label>
                                    <input type="text" class="form-control" name="perfect_money_password"
                                        value="{{ @$perfect_moneyInfo['perfect_money_password'] }}">
                                    @if ($errors->has('perfect_money_password'))
                                        <p class="mt-1 mb-0 text-danger">{{ $errors->first('perfect_money_password') }}
                                        </p>
                                    @endif
                                </div>
                                <div class="form-group">
                                    <label>{{ __('Name') }}</label>
                                    <input type="text" class="form-control" name="perfect_money_name"
                                        value="{{ @$perfect_moneyInfo['perfect_money_name'] }}">
                                    @if ($errors->has('perfect_money_name'))
                                        <p class="mt-1 mb-0 text-danger">{{ $errors->first('perfect_money_name') }}</p>
                                    @endif
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12">
                                    ...
                                    <div class="selectgroup w-100">
                                        <label class="selectgroup-item">
                                            <input type="radio" name="paytm_status" value="1"
                                                class="selectgroup-input"
                                                {{ $paytm->mobile_status == 1 ? 'checked' : '' }}>
                                            <span class="selectgroup-button">{{ __('Active') }}</span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input type="radio" name="paytm_status" value="0"
                                                class="selectgroup-input"
                                                {{ $paytm->mobile_status == 0 ? 'checked' : '' }}>
                                            <span class="selectgroup-button">{{ __('Deactive') }}</span>
                                        </label>
                                    </div>
                                ...
                                @php $paytmInfo = json_decode($paytm->mobile_information, true); @endphp

                                <div class="form-group">
                                    <label>{{ __('Paytm Environment') }}</label>
                                    <div class="selectgroup w-100">
                                        <label class="selectgroup-item">
                                            <input type="radio" name="paytm_environment" value="test"
                                                class="selectgroup-input"
                                                {{ @$paytmInfo['environment'] == 'test' ? 'checked' : '' }}>
                                            <span class="selectgroup-button">{{ __('Local') }}</span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input type="radio" name="paytm_environment" value="prod"
                                                class="selectgroup-input"
                                                {{ @$paytmInfo['environment'] == 'prod' ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    @if ($errors->has('paytm_merchant_website'))
                                        <p class="mt-1 mb-0 text-danger">{{ $errors->first('paytm_merchant_website') }}
                                        </p>
                                    @endif
                                </div>
