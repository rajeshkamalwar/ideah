        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-6 offset-lg-3">
              <form id="settingsForm" action="{{ route('admin.user_management.push_notification.update_settings') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                  ...
                  <div class="thumb-preview">
                    @if (!is_null($data->notification_image))
                      <img src="{{ asset('assets/img/' . $data->notification_image) }}" alt="image" class="uploaded-img">
                    @else
                  ...
                  <div class="row">
                    <div class="col">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="vapid_public_key" placeholder="{{ __('Enter VAPID Public Key') }}">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="vapid_private_key" placeholder="{{ __('Enter VAPID Private Key') }}">
