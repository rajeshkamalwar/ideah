              ...
              <form id="blogForm" action="{{ route('admin.blog_management.update_blog', ['id' => $blog->id]) }}"
                ...
                <div class="form-group">
                  ...
                  <div class="thumb-preview">
                    <img src="{{ asset('assets/img/blogs/' . $blog->image) }}" alt="image" class="uploaded-img">
                  </div>
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="number" name="serial_number"
                    placeholder="{{ __('Enter Serial Number') }}" value="{{ $blog->serial_number }}">
                          ...
                          <div class="row">
                            <div class="col">
                              <div class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
                                ...
                                <textarea class="form-control summernote" name="{{ $language->code }}_content" data-height="300">{{ is_null($blogData) ? '' : replaceBaseUrl($blogData->content, 'summernote') }}</textarea>
                              </div>
                            </div>
                          </div>
