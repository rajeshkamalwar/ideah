        ...
        <div class="card-header">
          <div class="row">
            <div class="col-lg-4">
              ...
              @endphp
              <div class="card-title d-inline-block">{{ __('Ticket Details') . ' -' }} <a
                  href="{{ route('admin.vendor_management.vendor_details', ['id' => $ticket->user_id, 'language' => $defaultLang->code]) }}"
                  class="btn btn-primary text-dark">{{ $vendori->username }}</a></div>
            ...
            <div class="col-lg-12">
              <div class="row">
                ...
                <div class="col-lg-12 my-3">
                  ...
                  @endif
                  <span class="badge badge-secondary">{{ date('dS F Y, h.i A', strtotime($ticket->created_at)) }}</span>
                </div>
              </div>
              <div class="row">
