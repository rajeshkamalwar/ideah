          ...
          <ul id="mainMenu" class="navbar-nav mobile-item mx-auto">
            @foreach ($menuDatas as $menuData)
              ...
              @if (!property_exists($menuData, 'children'))
                <li
                  class="nav-item {{ (!empty($menuData->type) && $menuData->type == 'events' && request()->routeIs('frontend.events*')) ? 'active' : '' }}">
                ...
                <li class="nav-item">
                  ...
                  <ul class="menu-dropdown">
                    ...
                    @foreach ($childMenuDatas as $childMenuData)
                      ...
                      <li
                        class="nav-item {{ (!empty($childMenuData->type) && $childMenuData->type == 'events' && request()->routeIs('frontend.events*')) ? 'active' : '' }}">
