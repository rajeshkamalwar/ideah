...
@section('content')
    ...
    <div class="listing-map-area pt-100">
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-9" data-aos="fade-up">
                    <div class="product-sort-area mt-4 mt-md-0 mb-20">
                        <div class="row align-items-center">
                            ...
                            <div class="col-6 d-xl-none">
                                <div class="text-lg-start text-end mb-20">
                                    <button class="btn btn-sm btn-primary icon-end radius-sm" type="button"
                                        data-bs-toggle="offcanvas" data-bs-target="#widgetOffcanvas"
                                        aria-controls="widgetOffcanvas">{{ __('Filter') }}<i class="fal fa-filter"></i>
                                    </button>
                                </div>
                            </div>
                            <div class="col-sm-12 col-lg-6 col-xl-12">
                                <div class="sort-item d-flex align-items-center justify-content-lg-end mb-20">
                                    <div class="item">
                                        <form>
                                            ...
                                            <select name="select_sort" id="select_sort" class="niceselect right color-dark">
                                                @if (request()->input('location'))
                                                    <option {{ request()->input('sort') == 'close-by' ? 'selected' : '' }}
                                                        value="close-by">
                                                        {{ __('Distance: Closest first') }}
                                                    </option>
                                                    <option
                                                        {{ request()->input('sort') == 'distance-away' ? 'selected' : '' }}
                                                        value="distance-away">
                                                    ...
                                                    <div class="d-flex align-items-center gap-2 ms-auto flex-shrink-0">
                                                        ...
                                                        @if (is_null($listing_content->vendor_id) || $listing_content->vendor_id == 0)
                                                            <a @if (!$claimed) href="#"
                                                                ...
                                                                data-bs-target="#ClaimRequestModal" @endif
