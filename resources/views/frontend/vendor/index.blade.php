                  ...
                  <div class="card-img">
                    <a href="{{ route('frontend.vendor.details', ['username' => 'admin']) }}"
                      ...
                      <img class="lazyload" src="{{ lazyImagePlaceholder() }}"
                        data-src="{{ vendorListingAuthorAvatarUrl(0, $admin) }}" alt="Vendor">
                    </a>
                  </div>
                  <div class="card-info">
                    <h6 class="title mb-1">
                    ...
                    <div>
                      ...
                      @endphp
                      <span>{{ __('Total Listings') . ':' }}&nbsp;</span>
                      <span class="color-dark">{{ $total_listings }}</span>
                    </div>
                  </div>
                </div>
                ...
                <div class="card-info-area bg-primary-light p-3">
                  <div class="card-img">
                    <a href="{{ route('frontend.vendor.details', ['username' => $vendor->username]) }}"
                      class="lazy-container ratio ratio-1-1 rounded-circle">
                      <img class="lazyload" src="{{ lazyImagePlaceholder() }}"
                        data-src="{{ vendorListingAuthorAvatarUrl($vendor->id, $vendor) }}" alt="Vendor">
                    </a>
                  </div>
                  <div class="card-info">
                    <h6 class="title mb-1">
