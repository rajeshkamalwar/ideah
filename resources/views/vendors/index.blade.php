...
@section('content')
    ...
    @php
        ...
        $package = \App\Http\Helpers\VendorPermissionHelper::subscriptionPlansEnabled()
            ? \App\Http\Helpers\VendorPermissionHelper::currentPackagePermission($vendor->id)
            : null;
    @endphp

    @if (\App\Http\Helpers\VendorPermissionHelper::subscriptionPlansEnabled() && is_null($package))
        @php
        ...
        @endif
    @elseif (\App\Http\Helpers\VendorPermissionHelper::subscriptionPlansEnabled())
    ...
    <div class="row dashboard-items">
                        ...
                        <div class="row">
                            ...
                            <div class="col-7 col-stats">
                                <div class="numbers">
                                    ...
                                    <h4 class="card-title">{{ number_format($vendor->amount ?? 0, 2) }}
                                        {{ $settings->base_currency_symbol ?? '$' }}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-sm-6 col-md-4">
            <a href="{{ route('vendor.listing_management.listings', ['language' => $defaultLang->code]) }}">
        ...
        @endif
        @if ($current_package != '[]' && \App\Http\Helpers\VendorPermissionHelper::subscriptionPlansEnabled())
            <div class="col-sm-6 col-md-4">
        ...
        {{-- New Card: Products (Assuming total products count) --}}
        <div class="col-sm-6 col-md-4">
            <a href="{{ route('vendor.shop_management.products', ['language' => $defaultLang->code]) }}">
                {{-- Adjust to your products route --}}
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header">
                    <div class="card-title">{{ __('Monthly Listing Posts') }} ({{ date('Y') }})</div>
                </div>
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header">
                    <div class="card-title">{{ __('Month wise visitors') }} ({{ date('Y') }})</div>
                </div>
...
@section('script')
    ...
    <script type="text/javascript" src="{{ asset('assets/admin/js/vendor-chart-init.js') }}"></script>
@endsection
