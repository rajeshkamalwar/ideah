                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-8 offset-lg-2">
                            ...
                            <form id="productForm"
                                action="{{ route('vendor.shop_management.update_product', ['id' => $product->id]) }}"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <select name="placement_type" class="form-control">
                                                ...
                                                <option value="1"
                                                    {{ $product->placement_type == '1' ? 'selected' : '' }}>
                                            ...
                                            <select name="listing_id" class="form-control">
                                                ...
                                                @foreach ($listings as $listing)
                                                    @if ($listing->listing_content->isNotEmpty())
                                                        <option value="{{ $listing->id }}" {{$product->listing_id == $listing->id ? 'selected' : ''  }}>
...
@section('script')
    <script>
        ...
        const imgDetachUrl = "{{ route('vendor.shop_management.detach_slider_image') }}";
