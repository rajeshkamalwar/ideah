...
@section('content')
  ...
  <div class="product-type">
    <div class="row">
      <div class="col-lg-6">
        <a href="{{ route('vendor.shop_management.create_product', ['type' => 'digital']) }}" class="d-block">
                ...
                <div class="col col-stats ml-3 ml-sm-0">
                  <div class="numbers mx-auto text-center">
                    ...
                    <p class="card-category">
                      <strong>{{ __('Total') . ': ' }}</strong>{{ $digitalProductCount . ' ' . __('Items') }}</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="col-lg-6">
        <a href="{{ route('vendor.shop_management.create_product', ['type' => 'physical']) }}" class="d-block">
          <div class="card card-stats card-round">
            <div class="card-body">
              <div class="row align-items-center">
                <div class="col-12">
                ...
                <div class="col col-stats ml-3 ml-sm-0">
                  <div class="numbers mx-auto text-center">
                    ...
                    <p class="card-category">
                      <strong>{{ __('Total') . ': ' }}</strong>{{ $physicalProductCount . ' ' . __('Items') }}</p>
                  </div>
                </div>
              </div>
            </div>
