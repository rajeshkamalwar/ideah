...
@section('content')
    <div class="page-header">
        ...
        <ul class="breadcrumbs">
            ...
            <li class="nav-item"><a href="#">{{ __('Form') }}</a></li>
            <li class="separator"><i class="flaticon-right-arrow"></i></li>
            <li class="nav-item"><a href="#">{{ __($form->name) }}</a></li>
            <li class="separator"><i class="flaticon-right-arrow"></i></li>
            <li class="nav-item"><a href="#">{{ __('Form Inputs') }}</a></li>
        </ul>
    </div>
        ...
        <div class="col-lg-7">
            <div class="card">
                <div class="card-header">
                    <div class="card-title d-inline-block">{{ __('Form Inputs') }}</div>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <p class="text-warning">
                                {{ '*' . __('Do not create') }}
                                <span class="text-info">{{ __('Name, Email & Phone Number') }}</span>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="ui-state-form">
                                <div class="ui-state-default ui-state-disabled">
                                    <div class="form-group">
                                        <label>{{ __('Name') . '*' }}</label>
                                        <input type="text" class="form-control" placeholder="{{ __('Enter Your Full Name') }}" disabled>
                                    </div>
                                </div>
                                <div class="ui-state-default ui-state-disabled">
                                    <div class="form-group">
                                        <label>{{ __('Email Address') . '*' }}</label>
                                        <input type="email" class="form-control" placeholder="{{ __('Enter Your Email Address') }}" disabled>
                                    </div>
                                </div>
                                ...
                                @if ($inputFields->count() > 0)
                                    <div id="sort-content">
                                        @foreach ($inputFields as $inputField)
                                            @php $options = is_string($inputField->options) ? json_decode($inputField->options) : $inputField->options; @endphp
                                            {{-- Text Field --}}
                                            @if ($inputField->type == 1)
                                                <form class="ui-state-default"
                                                    action="{{ route('vendor.listings-management.form.delete_input', ['id' => $inputField->id]) }}"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="row no-gutters">
                                                            ...
                                                            <div class="col-lg-2">
                                                                <a href="{{ route('vendor.listings-management.form.edit_input', ['form_id' => $form->id, 'input_id' => $inputField->id, 'language' => $language->code]) }}"
                                            ...
                                            @elseif ($inputField->type == 3)
                                                <form class="ui-state-default"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="row no-gutters">
                                                            <div class="col-lg-9 mr-3">
                                                                <select class="form-control" name="{{ $inputField->name }}" readonly>
                                            ...
                                            @elseif ($inputField->type == 5)
                                                <form class="ui-state-default"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="row no-gutters">
                                                            <div class="col-lg-9 mr-3">
                                                                <textarea class="form-control" name="{{ $inputField->name }}" rows="5"
                                                                    cols="50" placeholder="{{ $inputField->placeholder }}" ></textarea>
                                                            </div>
                                                            <div class="col-lg-2">
                                                                <a href="{{ route('vendor.listings-management.form.edit_input', ['form_id' => $form->id, 'input_id' => $inputField->id, 'language' => $language->code]) }}"
                                                                    class="btn btn-sm btn-secondary mt-1"><i class="fas fa-edit text-white"></i></a>
                                                        ...
                                                        <div class="row no-gutters">
                                                            <div class="col-lg-9 mr-3">
                                                                <input type="text" class="form-control datepicker"
                                                                    name="{{ $inputField->name }}"
                                                                    placeholder="{{ $inputField->placeholder }}" autocomplete="off" readonly>
                                                            </div>
                                                            <div class="col-lg-2">
                                                                <a href="{{ route('vendor.listings-management.form.edit_input', ['form_id' => $form->id, 'input_id' => $inputField->id, 'language' => $language->code]) }}"
                                                                    class="btn btn-sm btn-secondary mt-1">
                                            ...
                                            @elseif ($inputField->type == 8)
                                                <form class="ui-state-default"
                                                    ...
                                                    <div class="form-group">
                                                        <label>
                                                            {{ $inputField->label }}{{ $inputField->is_required == 1 ? '*' : '' }}
                                                            ({{ __('Maximum Size') . ' ' . $inputField->file_size . ' MB' }})
                                                        </label>
                                                        <div class="row no-gutters">
                                                            <div class="col-lg-9 mr-3">
                                                                <input type="file" name="{{ $inputField->name }}" class="form-control" readonly>
                                                            </div>
                                                            <div class="col-lg-2">
                                                                <a href="{{ route('vendor.listings-management.form.edit_input', ['form_id' => $form->id, 'input_id' => $inputField->id, 'language' => $language->code]) }}"
                                                                    class="btn btn-sm btn-secondary mt-1">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <a href="{{ route('vendor.listings-management.form.index', ['language' => $language->code]) }}"
                                class="btn btn-info btn-sm float-right">
                                <span class="btn-label"><i class="fas fa-backward mdb_12"></i></span>
                                {{ __('Back') }}
                            </a>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    <form id="ajaxForm"
                        action="{{ route('vendor.listings-management.form.store_input', ['id' => $form->id]) }}"
                        method="POST">
                        @csrf
                        <div class="form-group">
                            ...
                            <div class="form-check form-check-inline pl-0">
                                <input type="radio" class="form-check-input" name="type" value="1"
                                    id="input-type-1" v-model="inputType" v-on:change="changeInputType()">
                            ...
                            <div class="form-check form-check-inline pl-0">
                                <input type="radio" class="form-check-input" name="type" value="2"
                                    id="input-type-2" v-model="inputType" v-on:change="changeInputType()">
                            ...
                            <div class="form-check form-check-inline pl-0">
                                <input type="radio" class="form-check-input" name="type" value="3"
                                    id="input-type-3" v-model="inputType" v-on:change="changeInputType()">
                            ...
                            <div class="form-check form-check-inline pl-0">
                                <input type="radio" class="form-check-input" name="type" value="4"
                                    id="input-type-4" v-model="inputType" v-on:change="changeInputType()">
                            ...
                            <div class="form-check form-check-inline pl-0">
                                <input type="radio" class="form-check-input" name="type" value="5"
                                    id="input-type-5" v-model="inputType" v-on:change="changeInputType()">
                                <label class="form-check-label mt-2" for="input-type-5">{{ __('Textarea') }}</label>
                            </div>
                            <div class="form-check form-check-inline pl-0">
                                <input type="radio" class="form-check-input" name="type" value="6"
                                    id="input-type-6" v-model="inputType" v-on:change="changeInputType()">
                                <label class="form-check-label mt-2" for="input-type-6">{{ __('Datepicker') }}</label>
                            </div>
                            <div class="form-check form-check-inline pl-0">
                                <input type="radio" class="form-check-input" name="type" value="7"
                                    id="input-type-7" v-model="inputType" v-on:change="changeInputType()">
                                <label class="form-check-label mt-2" for="input-type-7">{{ __('Timepicker') }}</label>
                            </div>
                            <div class="form-check form-check-inline pl-0">
                                <input type="radio" class="form-check-input" name="type" value="8"
                                    id="input-type-8" v-model="inputType" v-on:change="changeInputType()">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="label"
                                placeholder="{{ __('Enter Input Label') }}">
                        ...
                        <div class="form-group" v-if="showPlaceholder">
                            ...
                            <input type="text" class="form-control" name="placeholder"
                                placeholder="{{ __('Enter Input Placeholder') }}">
                                    ...
                                    <div class="col-lg-10">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="options[]"
                                                placeholder="{{ __('Enter Option') }}">
                                        </div>
                                    </div>
                                    <div class="col-lg-2">
                                        <button class="btn btn-danger btn-sm mt-3" v-on:click="removeOption()"><i class="fas fa-times"></i></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group" v-if="showFileSize">
                            ...
                            <div class="input-group">
                                <input type="number" step="0.01" class="form-control ltr" name="file_size"
                                    placeholder="{{ __('Enter File Size') }}">
...
@section('script')
    <script type="text/javascript">
        ...
        const sortURL = "{{ route('vendor.listings-management.form.sort_input') }}";
    </script>
    <script type="text/javascript" src="{{ asset('assets/admin/js/vue-js.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('assets/admin/js/form-input.js') }}"></script>
@endsection
