...
@section('content')
    <div class="page-header">
        ...
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a href="{{ route('vendor.listings-management.form.input', ['id' => $form->id, 'language' => $language->code]) }}">{{ __($form->name) }}</a>
            </li>
            <li class="separator">
                <i class="flaticon-right-arrow"></i>
            </li>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-6">
                            <form id="ajaxEditForm"
                                action="{{ route('vendor.listings-management.form.update_input', ['id' => $inputField->id]) }}"
                                method="POST">
                                @csrf
