...
@section('content')
  <div class="page-header">
    <h4 class="page-title">{{ __('Tax Amount') }}</h4>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        <form action="{{ route('vendor.shop_management.update_tax_amount') }}" method="post">
          @csrf
          <div class="card-header">
            <div class="row">
              <div class="col-lg-10">
                <div class="card-title">{{ __('Tax Amount') }}</div>
              </div>
            </div>
          </div>
