...
@section('content')
  ...
  <div class="text-right mb-3">
    <a href="{{ route('vendor.shop_management.orders') }}" class="btn btn-primary">{{ __('Back') }}</a>
  </div>
        ...
        <div class="card-body">
          <div class="payment-information">
            ...
            <div class="row mb-2">
              ...
              <div class="col-lg-6">
                {{ $position == 'left' ? $currency . ' ' : '' }}{{ number_format($vendorCartTotal, 2, '.', ',') }}{{ $position == 'right' ? ' ' . $currency : '' }}
              </div>
            </div>
            ...
            <div class="row mb-2">
              ...
              <div class="col-lg-6">
                {{ $position == 'left' ? $currency . ' ' : '' }}{{ number_format($totalVendorDiscount, 2) }}{{ $position == 'right' ? ' ' . $currency : '' }}
              </div>
            </div>
            ...
            <div class="row mb-2">
              ...
              <div class="col-lg-6">
                @php
                  $total = floatval($vendorCartTotal);
                  $discount = floatval($totalVendorDiscount);
            ...
            <div class="row mb-2">
              <div class="col-lg-6">
                <strong>{{ __('Commission') }} <span class="text-success">({{ __('Received by admin') }})</span> :</strong>
              </div>

              <div class="col-lg-6">
                {{ $position == 'left' ? $currency . ' ' : '' }}{{ number_format($totalVendorCommission, 2) }}{{ $position == 'right' ? ' ' . $currency : '' }}
              </div>
            </div>

            <div class="row mb-2">
              <div class="col-lg-6">
                <strong>{{ __('Shipping Cost') }} <span class="text-success">({{ __('Received by admin') }})</span>
                  :</strong>
              </div>
            ...
            <div class="row mb-2">
              <div class="col-lg-6">
                <strong>{{ __('Tax') }} {{ '(' . $tax->product_tax_amount . '%)' }} <span class="text-success">({{ __('Received by admin') }})</span> :</strong>
              </div>

              <div class="col-lg-6">
                {{ $position == 'left' ? $currency . ' ' : '' }}{{ number_format($vendorTax, 2) }}{{ $position == 'right' ? ' ' . $currency : '' }}
              </div>
            </div>
            ...
            <div class="row mb-2">
              ...
              <div class="col-lg-6">
                {{ $position == 'left' ? $currency . ' ' : '' }}{{ number_format($vendorNetTotal, 2, '.', ',') }}{{ $position == 'right' ? ' ' . $currency : '' }}
              </div>
            </div>
