...
@section('content')
    <div class="page-header">
        <h4 class="page-title">{{ __('Make a Request') }}</h4>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        @php
                            $currentBalance = Auth::guard('vendor')->user()->amount;
                        @endphp
                        <div class="col-lg-4">
                            ...
                            <form id="ajaxForm" action="{{ route('vendor.withdraw.send-request') }}" method="POST"
                                ...
                                @if ($errors->any())
                                    <div class="alert alert-danger">
                                        <p><strong>{{ __('Opps') . ', ' . __('Something went wrong') }}</strong></p>
                                        <ul>
...
@endsection
@section('script')
    <script src="{{ asset('assets/admin/js/seller-withdraw.js') }}"></script>
