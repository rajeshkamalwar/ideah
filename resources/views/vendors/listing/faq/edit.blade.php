  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="ajaxEditForm" class="modal-form" action="{{ route('vendor.listing_management.listing.update_faq') }}"
          method="post">
          @csrf
          ...
          <div class="form-group">
            ...
            <p id="editErr_question" class="mt-2 mb-0 text-danger em"></p>
          </div>
          ...
          <div class="form-group">
            ...
            <p id="editErr_answer" class="mt-2 mb-0 text-danger em"></p>
          </div>
